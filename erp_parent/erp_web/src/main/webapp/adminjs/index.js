...
$(function(){
	...
	$.post('menu_getMunesByEmpuuid.action',function (result) {
        _menus=result;
        InitLeftMenu();
    },'json')
	 ...
	 * 显示姓名
     */
    $.post('login_showName',function (result) {
        if (result.success) {
            $('#usernamespan').text(result.message)
        }else{
 ...
 */
function logOut (){
    $.post('login_logOut',function (result) {
...
function serverLogin() {
    ...
    $.post('emp_updatePwd?newPwd=' + $newpass.val()+'&oldPwd='+$oldpass.val(), function(msg) {
        if (msg.success){
            ...
            msgShow('系统提示','对不起，密码修改失败！<br>'+msg.message,'info');
        }
    },'json')
